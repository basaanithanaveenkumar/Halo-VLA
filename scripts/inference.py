...
def evaluate_dataset(args):
    ...
    logger.info("Eval samples: %d  |  Batches: %d", len(loader.dataset), len(loader))
    ...
    logger.info("=" * 60)
    logger.info("Evaluation done in %.1fs  (%d batches)", elapsed, total_batches)
